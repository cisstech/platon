...
/**
 * Data of the {@link FileChangeEvent} event.
 */
export interface FileChangeEventData {
  ...
  /**
   * Display the author of the commit
   */
  displayAuthor: boolean

  /**
   * Is there more commits
   */
  isMore: boolean
}

/**
 * Event triggered when a commit is done.
 */
export interface FileChangeEvent extends ResourceEvent<FileChangeEventData> {
  readonly type: ResourceEventTypes.RESOURCE_FILE_CHANGE
}
