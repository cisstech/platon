...
import { ExerciseResults, TeacherResultsData, UserResults } from '@platon/feature/answer/common';
...
export class AnswerService {
  ...
  async resultsForTeacher(activityId: string): Promise<TeacherResultsData> {
