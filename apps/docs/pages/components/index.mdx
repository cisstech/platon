...
description: Présentation du framework de composants PLaTon, expliquant les types disponibles (formulaire et widget), leur fonctionnement basé sur l'architecture MVC, et comment les utiliser et contribuer au développement de nouveaux composants.
