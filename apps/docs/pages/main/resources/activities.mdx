...
description: Instructions détaillées pour créer des activités dans PLaTon. Guide le processus en trois étapes incluant la sélection du cercle parent, la définition des informations de base et l'assignation des tags pour la classification.
---
