...
<Callout type="info">
Si vous ouvrez le formulaire de création d'activité à partir de la page d'une ressource, le cercle parent sera automatiquement sélectionné comme étant le cercle dans lequel se trouve la ressource.
</Callout>
