...
<Callout type="info">
Par défaut, le type de feedback est un objet, mais il est possible d'afficher plusieurs feedbacks à l'apprenant en utilisant un tableau d'objets de feedback.
