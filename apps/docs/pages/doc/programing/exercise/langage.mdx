...
<Tabs items={['main.ple', 'parent.ple']}>
  <Tabs.Tab>``` @extends parent.ple key1 = 0 ```</Tabs.Tab>
  <Tabs.Tab>``` key1 = 5 key2 = "toto" ```</Tabs.Tab>
</Tabs>
...
<Tabs items={['main.ple', 'parent.ple']}>
  <Tabs.Tab>``` mydict = @extends parent.ple mydict.key1 = 0 ```</Tabs.Tab>
  <Tabs.Tab>``` key1 = 5 ```</Tabs.Tab>
</Tabs>
