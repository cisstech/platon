...
export class LinkSessionAndSessionData1728546988778 implements MigrationInterface {
    name = 'LinkSessionAndSessionData1728546988778'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            insert into public."SessionData" (
            id,
            user_id,
            parent_id,
            grade,
        ...
        await queryRunner.query(`ALTER TABLE "SessionData" ADD CONSTRAINT "UQ_13ff82dd33850a23b6d2f6dc472" UNIQUE ("id")`);
        await queryRunner.query(`ALTER TABLE "SessionData" ADD CONSTRAINT "FK_13ff82dd33850a23b6d2f6dc472" FOREIGN KEY ("id") REFERENCES "Sessions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);

    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "SessionData" DROP CONSTRAINT "FK_13ff82dd33850a23b6d2f6dc472"`);
        await queryRunner.query(`ALTER TABLE "SessionData" DROP CONSTRAINT "UQ_13ff82dd33850a23b6d2f6dc472"`);
    }
