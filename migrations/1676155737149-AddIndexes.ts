...
export class AddIndexes1676155737149 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_eef52c8c4b9357a1248ce1605a" ON "Levels" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_c28d98ffab0b7443b96ba0fd95" ON "Levels" ("updated_at") `
    )
    await queryRunner.query(`CREATE UNIQUE INDEX "Levels_name_idx" ON "Levels" (f_unaccent(name)) `)
    await queryRunner.query(
      `CREATE INDEX "IDX_e36823495b6fd5e00aeceedc43" ON "Topics" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_7c17033a55b179291064cc3809" ON "Topics" ("updated_at") `
    )
    await queryRunner.query(`CREATE UNIQUE INDEX "Topics_name_idx" ON "Topics" (f_unaccent(name)) `)
    await queryRunner.query(
      `CREATE INDEX "IDX_932652535a6e452f74d450dfb7" ON "Users" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_5abe0e95e97c3e6b9858dbc781" ON "Users" ("updated_at") `
    )
    await queryRunner.query(`CREATE UNIQUE INDEX "Users_username_idx" ON "Users" ("username") `)
    await queryRunner.query(
      `CREATE INDEX "Users_first_name_idx" ON "Users" (f_unaccent(first_name)) `
    )
    await queryRunner.query(
      `CREATE INDEX "Users_last_name_idx" ON "Users" (f_unaccent(last_name)) `
    )
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_874e99ed7aa65dfe03603ecd4e" ON "UserPrefs" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_6741094322252383e01c52f60b" ON "UserPrefs" ("updated_at") `
    )
    await queryRunner.query(`CREATE INDEX "UserPrefs_user_id_idx" ON "UserPrefs" ("user_id") `)
    await queryRunner.query(
      `CREATE INDEX "IDX_12d86f8dcdcfd980520472524c" ON "Lmses" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_957d045337161dce0eccf6a5be" ON "Lmses" ("updated_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_b5b7714a4e20d9ee196c6e09b7" ON "Resources" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_9bac50be3c70b5925224c2516e" ON "Resources" ("updated_at") `
    )
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_70fc927171cc41d0c967cfb059" ON "ResourceEvents" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_42bf93a101e4cf2566e6cb0eba" ON "ResourceEvents" ("updated_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "ResourceEvents_actor_id_idx" ON "ResourceEvents" ("actor_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "ResourceEvents_resource_id_idx" ON "ResourceEvents" ("resource_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_6ad48b5c0001176687589f3859" ON "ResourceInvitations" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_23877e5e014f41874b2f9b0549" ON "ResourceInvitations" ("updated_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_bfd3ad6ff767408be421ee5e2c" ON "ResourceMembers" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_3dc73bc260a636d8dc5b8665fc" ON "ResourceMembers" ("updated_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_934cace09a24968ffc40b0374a" ON "ResourceViews" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_d314c179fb30cf2fd0acb9b7e5" ON "ResourceViews" ("updated_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_ae9d2e2771addff9fb2af20079" ON "LmsUsers" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_e3803383ee0c23c2dcbbb1fecf" ON "LmsUsers" ("updated_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_f2c4d7997d56c193ab00aa2ea7" ON "ResourceWatchers" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_723405bc72447213ed10426dfe" ON "ResourceWatchers" ("updated_at") `
    )
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Users" ADD CONSTRAINT "Users_unique_idx" UNIQUE ("username")`
    )
  }
}
