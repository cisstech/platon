...
export class MakeUserIdOptionalInCourseMemberRenameGroupToUserGroupsUsers1678014152933
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "CourseMembers" DROP CONSTRAINT "CourseMembers_unique_idx"`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_f6a956d8c5140accecc5932bcf" ON "UserGroupsUsers" ("group_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_a7a04b4af2ac1c12b7be1555a2" ON "UserGroupsUsers" ("user_id") `
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "UserGroupsUsers" DROP CONSTRAINT "FK_a7a04b4af2ac1c12b7be1555a24"`
    )
    await queryRunner.query(
      `ALTER TABLE "UserGroupsUsers" DROP CONSTRAINT "FK_f6a956d8c5140accecc5932bcf0"`
    )
    await queryRunner.query(
      `ALTER TABLE "CourseMembers" DROP CONSTRAINT "FK_0fe0c8fe001f97079be532dd78b"`
    )
    await queryRunner.query(
      `ALTER TABLE "CourseMembers" DROP CONSTRAINT "CourseMembers_unique_user_idx"`
    )
    await queryRunner.query(
      `ALTER TABLE "CourseMembers" DROP CONSTRAINT "CourseMembers_unique_group_idx"`
    )
