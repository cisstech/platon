...
export class MakeUserIdOptionalInCourseMemberRenameGroupToUserGroupsUsers1678014152933 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "UserGroupsUsers" ("group_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_39988ad1ed21b0256f94d1fa746" PRIMARY KEY ("group_id", "user_id"))`);
    ...
    await queryRunner.query(`ALTER TABLE "CourseMembers" ADD CONSTRAINT "CourseMembers_unique_group_idx" UNIQUE ("course_id", "group_id")`);
    await queryRunner.query(`ALTER TABLE "CourseMembers" ADD CONSTRAINT "CourseMembers_unique_user_idx" UNIQUE ("course_id", "user_id")`);
    ...
    await queryRunner.query(`ALTER TABLE "UserGroupsUsers" ADD CONSTRAINT "FK_f6a956d8c5140accecc5932bcf0" FOREIGN KEY ("group_id") REFERENCES "UserGroups"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    await queryRunner.query(`ALTER TABLE "UserGroupsUsers" ADD CONSTRAINT "FK_a7a04b4af2ac1c12b7be1555a24" FOREIGN KEY ("user_id") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "CourseMembers" ADD CONSTRAINT "CourseMembers_unique_idx" UNIQUE ("user_id", "course_id")`);
  }
