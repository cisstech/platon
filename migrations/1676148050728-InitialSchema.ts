...
export class InitialSchema1676148050728 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Levels" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_18322e8ea03ecac3d45160cb96d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Topics" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_1ef7dd03abee738fa3199b5134d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."ResourceEvents_type_enum" AS ENUM('MEMBER_CREATE', 'MEMBER_REMOVE', 'RESOURCE_CREATE', 'RESOURCE_STATUS_CHANGE')`);
        ...
        await queryRunner.query(`CREATE TABLE "UserLevels" ("user_prefs_id" uuid NOT NULL, "level_id" uuid NOT NULL, CONSTRAINT "PK_7039085cc78b7b8c8482e00dd3d" PRIMARY KEY ("user_prefs_id", "level_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "UserTopics" ("user_prefs_id" uuid NOT NULL, "topic_id" uuid NOT NULL, CONSTRAINT "PK_301ca3b58f4107df586829da3e3" PRIMARY KEY ("user_prefs_id", "topic_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ResourceLevels" ("resource_id" uuid NOT NULL, "level_id" uuid NOT NULL, CONSTRAINT "PK_6fdd494d8980cf8ad1c5ea4db47" PRIMARY KEY ("resource_id", "level_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ResourceTopics" ("resource_id" uuid NOT NULL, "topic_id" uuid NOT NULL, CONSTRAINT "PK_ad0fc2468681504d733292cf581" PRIMARY KEY ("resource_id", "topic_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "UserLevels" ADD CONSTRAINT "FK_8735a6f4afd0dfe5dcc6d6e77da" FOREIGN KEY ("user_prefs_id") REFERENCES "UserPrefs"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "UserLevels" ADD CONSTRAINT "FK_1387f8a570fae868d582ab46aea" FOREIGN KEY ("level_id") REFERENCES "Levels"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "UserTopics" ADD CONSTRAINT "FK_fce7580c8fd680af994174b3142" FOREIGN KEY ("user_prefs_id") REFERENCES "UserPrefs"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "UserTopics" ADD CONSTRAINT "FK_4d7b8431b1b7f2f1055369a9ebe" FOREIGN KEY ("topic_id") REFERENCES "Topics"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ResourceLevels" ADD CONSTRAINT "FK_4120a12a69797d728bbc493ed8b" FOREIGN KEY ("resource_id") REFERENCES "Resources"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ResourceLevels" ADD CONSTRAINT "FK_5639b23d5431cc19ceb5f0c999d" FOREIGN KEY ("level_id") REFERENCES "Levels"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ResourceTopics" ADD CONSTRAINT "FK_d811c7a06f9fff035341aa7b3eb" FOREIGN KEY ("resource_id") REFERENCES "Resources"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ResourceTopics" ADD CONSTRAINT "FK_8b695e3fba4b1bb0fe9c023240c" FOREIGN KEY ("topic_id") REFERENCES "Topics"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
