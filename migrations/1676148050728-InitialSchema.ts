...
export class InitialSchema1676148050728 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."Resources_type_enum" AS ENUM('CIRCLE', 'EXERCISE', 'ACTIVITY')`
    )
    await queryRunner.query(
      `CREATE TYPE "public"."Resources_visibility_enum" AS ENUM('PUBLIC', 'PRIVATE', 'PERSONAL')`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_8735a6f4afd0dfe5dcc6d6e77d" ON "UserLevels" ("user_prefs_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_1387f8a570fae868d582ab46ae" ON "UserLevels" ("level_id") `
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_fce7580c8fd680af994174b314" ON "UserTopics" ("user_prefs_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_4d7b8431b1b7f2f1055369a9eb" ON "UserTopics" ("topic_id") `
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_4120a12a69797d728bbc493ed8" ON "ResourceLevels" ("resource_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_5639b23d5431cc19ceb5f0c999" ON "ResourceLevels" ("level_id") `
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_d811c7a06f9fff035341aa7b3e" ON "ResourceTopics" ("resource_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_8b695e3fba4b1bb0fe9c023240" ON "ResourceTopics" ("topic_id") `
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "ResourceTopics" DROP CONSTRAINT "FK_8b695e3fba4b1bb0fe9c023240c"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceTopics" DROP CONSTRAINT "FK_d811c7a06f9fff035341aa7b3eb"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceLevels" DROP CONSTRAINT "FK_5639b23d5431cc19ceb5f0c999d"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceLevels" DROP CONSTRAINT "FK_4120a12a69797d728bbc493ed8b"`
    )
    await queryRunner.query(
      `ALTER TABLE "UserTopics" DROP CONSTRAINT "FK_4d7b8431b1b7f2f1055369a9ebe"`
    )
    await queryRunner.query(
      `ALTER TABLE "UserTopics" DROP CONSTRAINT "FK_fce7580c8fd680af994174b3142"`
    )
    await queryRunner.query(
      `ALTER TABLE "UserLevels" DROP CONSTRAINT "FK_1387f8a570fae868d582ab46aea"`
    )
    await queryRunner.query(
      `ALTER TABLE "UserLevels" DROP CONSTRAINT "FK_8735a6f4afd0dfe5dcc6d6e77da"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceEvents" DROP CONSTRAINT "FK_371048782c4848e75a0a2a7ddd9"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceEvents" DROP CONSTRAINT "FK_849b795c276b83abb2036e72f66"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceWatchers" DROP CONSTRAINT "FK_3dd3c8e2e204466dc41a3b80d99"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceWatchers" DROP CONSTRAINT "FK_b5ae51081d7ed4c46884fafe53e"`
    )
    await queryRunner.query(
      `ALTER TABLE "LmsUsers" DROP CONSTRAINT "FK_8aac849edd33180c080cfddd9eb"`
    )
    await queryRunner.query(
      `ALTER TABLE "LmsUsers" DROP CONSTRAINT "FK_f54bf115485bb640e184edda955"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceInvitations" DROP CONSTRAINT "FK_4e036ec09e73efafbc2b9c9dcfd"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceInvitations" DROP CONSTRAINT "FK_8092663f4800cbfb8268f3bc87a"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceInvitations" DROP CONSTRAINT "FK_b0163fcaa15a025dd5da3f73dfb"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceViews" DROP CONSTRAINT "FK_9561f3e1485d892c0e308afe18a"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceViews" DROP CONSTRAINT "FK_87dce3fcc7b916a1016b8cde645"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceMembers" DROP CONSTRAINT "FK_a47597e9cbddc1c574fe4b70d78"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceMembers" DROP CONSTRAINT "FK_237b0d8a393e65f583d1093f34b"`
    )
    await queryRunner.query(
      `ALTER TABLE "ResourceMembers" DROP CONSTRAINT "FK_c46df0966d90f8f2906f1722a1c"`
    )
    await queryRunner.query(
      `ALTER TABLE "Resources" DROP CONSTRAINT "FK_04788812f73f37dda1257a47188"`
    )
    await queryRunner.query(
      `ALTER TABLE "Resources" DROP CONSTRAINT "FK_200b6df5e4626a409c34ff439f4"`
    )
    await queryRunner.query(
      `ALTER TABLE "UserPrefs" DROP CONSTRAINT "FK_72085e53d2fe43668d3f38d3f1f"`
    )
