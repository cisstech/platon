...
export class AddUserGroupsAndCourseMembersEntity1677868930815 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_3aee2a43a2b66011304b529055" ON "UserGroups" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_bdd234c9d0546c66d5258427a8" ON "UserGroups" ("updated_at") `
    )
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_c29cd877bcaa59bb781bbd426d" ON "CourseMembers" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_67b5aca86c71e51fe125dd96eb" ON "CourseMembers" ("updated_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "CourseMembers_course_id_idx" ON "CourseMembers" ("course_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "CourseMembers_group_id_idx" ON "CourseMembers" ("group_id") `
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_9f7abc33c76411bf99f9e3474f" ON "Groups" ("group_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_cb5b2af873dd015294051fd395" ON "Groups" ("user_id") `
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "CourseMembers" DROP CONSTRAINT "FK_693638072af3ebd7b1c8d944993"`
    )
    await queryRunner.query(
      `ALTER TABLE "CourseMembers" DROP CONSTRAINT "FK_d1ee53034c4424ff52960d8c746"`
    )
    await queryRunner.query(
      `ALTER TABLE "CourseMembers" DROP CONSTRAINT "FK_0fe0c8fe001f97079be532dd78b"`
    )
