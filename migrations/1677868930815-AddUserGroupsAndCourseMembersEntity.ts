...
export class AddUserGroupsAndCourseMembersEntity1677868930815 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "UserGroups" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, CONSTRAINT "PK_f8840480e6172875eac084b661d" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "Groups" ("group_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_673fe878700fb3c7bf5e38b007f" PRIMARY KEY ("group_id", "user_id"))`);
    ...
    await queryRunner.query(`ALTER TABLE "CourseMembers" ADD CONSTRAINT "FK_0fe0c8fe001f97079be532dd78b" FOREIGN KEY ("user_id") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "CourseMembers" ADD CONSTRAINT "FK_d1ee53034c4424ff52960d8c746" FOREIGN KEY ("course_id") REFERENCES "Courses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "CourseMembers" ADD CONSTRAINT "FK_693638072af3ebd7b1c8d944993" FOREIGN KEY ("group_id") REFERENCES "UserGroups"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "Groups" ADD CONSTRAINT "FK_9f7abc33c76411bf99f9e3474fb" FOREIGN KEY ("group_id") REFERENCES "UserGroups"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    await queryRunner.query(`ALTER TABLE "Groups" ADD CONSTRAINT "FK_cb5b2af873dd015294051fd3954" FOREIGN KEY ("user_id") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
  }
