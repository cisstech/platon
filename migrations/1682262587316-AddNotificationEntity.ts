...
export class AddNotificationEntity1682262587316 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_25d354306e232a47a9caf2c844" ON "Notifications" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_83a2c61c57d9d6c2cb48dccbf1" ON "Notifications" ("updated_at") `
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "Notifications" DROP CONSTRAINT "FK_58ecf3b94e7e8f3187e0fd21d6f"`
    )
