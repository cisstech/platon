...
export class AddNotificationEntity1682262587316 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Notifications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "read_at" TIMESTAMP WITH TIME ZONE, "data" jsonb NOT NULL, CONSTRAINT "PK_c77268afe7d3c5568da66c5bebe" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Notifications" ADD CONSTRAINT "FK_58ecf3b94e7e8f3187e0fd21d6f" FOREIGN KEY ("user_id") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
