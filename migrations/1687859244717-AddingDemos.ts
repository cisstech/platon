...
export class AddingDemos1687859244717 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "CourseDemos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "course_id" uuid, CONSTRAINT "PK_63cdbbb54cb880e3444509fbf1a" PRIMARY KEY ("id"))`
    )
    ...
    await queryRunner.query(
      `ALTER TABLE "CourseDemos" ADD CONSTRAINT "FK_607aec97c2683dd298b505f0a9c" FOREIGN KEY ("course_id") REFERENCES "Courses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )
  }
