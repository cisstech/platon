...
export class OptimizeEntities1681050639246 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX "Activities_creator_id_idx" ON "Activities" ("creator_id") `)
    await queryRunner.query(`CREATE INDEX "Activities_section_id_idx" ON "Activities" ("section_id") `)
    await queryRunner.query(`CREATE INDEX "CourseMembers_user_id_idx" ON "CourseMembers" ("user_id") `)
    await queryRunner.query(`CREATE INDEX "ActivityCorrectors_member_id_idx" ON "ActivityCorrectors" ("member_id") `)
    await queryRunner.query(`CREATE INDEX "ActivityCorrectors_user_id_idx" ON "ActivityCorrectors" ("user_id") `)
    await queryRunner.query(`CREATE INDEX "ActivityMembers_member_id_idx" ON "ActivityMembers" ("member_id") `)
    await queryRunner.query(`CREATE INDEX "ActivityMembers_user_id_idx" ON "ActivityMembers" ("user_id") `)
