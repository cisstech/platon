...
export class AddSessionCommentEntitiesAndUpdateSessionCorrectionColumnType1681134729203 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Corrections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "author_id" uuid NOT NULL, "grade" double precision NOT NULL, CONSTRAINT "PK_8f5ad3277a14b403c893dbee0d7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "SessionComments_session_id_answer_id_idx" ON "SessionComments" ("session_id", "answer_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "Sessions" ADD CONSTRAINT "FK_1a297633a424659cfacef3fd74b" FOREIGN KEY ("correction_id") REFERENCES "Corrections"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "SessionComments" ADD CONSTRAINT "FK_5d9481cc272ef0cec6f3d38df22" FOREIGN KEY ("session_id") REFERENCES "Sessions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "SessionComments" ADD CONSTRAINT "FK_f48162f91074d0d34a99acba93a" FOREIGN KEY ("answer_id") REFERENCES "Answers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
