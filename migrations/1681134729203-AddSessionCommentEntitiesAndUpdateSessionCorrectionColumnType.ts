...
export class AddSessionCommentEntitiesAndUpdateSessionCorrectionColumnType1681134729203
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_4e0655114fd989e16947e760b0" ON "Corrections" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_ee1df9539b7bff6de4e9340015" ON "Corrections" ("updated_at") `
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_dd2adc77f27f0e4ea65f39408e" ON "SessionComments" ("created_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_6e35d03db1940f7cff6213c81e" ON "SessionComments" ("updated_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "SessionComments_session_id_idx" ON "SessionComments" ("session_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "SessionComments_answer_id_idx" ON "SessionComments" ("answer_id") `
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "SessionComments" DROP CONSTRAINT "FK_f48162f91074d0d34a99acba93a"`
    )
    await queryRunner.query(
      `ALTER TABLE "SessionComments" DROP CONSTRAINT "FK_5d9481cc272ef0cec6f3d38df22"`
    )
    await queryRunner.query(
      `ALTER TABLE "SessionComments" DROP CONSTRAINT "FK_f9b40f64a0e46f54b27200632d9"`
    )
    await queryRunner.query(
      `ALTER TABLE "Sessions" DROP CONSTRAINT "FK_1a297633a424659cfacef3fd74b"`
    )
    await queryRunner.query(
      `ALTER TABLE "Corrections" DROP CONSTRAINT "FK_2c2c7673fe8ffbd2b4eb2bd3d2d"`
    )
    await queryRunner.query(`ALTER TABLE "Sessions" DROP COLUMN "correction_id"`)
