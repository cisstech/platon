...
export class UpdateTables1679938776451 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "CourseActivityMembers" ("activity_id" uuid NOT NULL, "member_id" uuid NOT NULL, CONSTRAINT "PK_08bd1dfdda277ff40721a28094f" PRIMARY KEY ("activity_id", "member_id"))`);
    ...
    await queryRunner.query(`ALTER TABLE "CourseActivityMembers" ADD CONSTRAINT "FK_3fabd37d14c4d00a506312d618b" FOREIGN KEY ("activity_id") REFERENCES "CourseActivities"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    await queryRunner.query(`ALTER TABLE "CourseActivityMembers" ADD CONSTRAINT "FK_11ea4d9d96617503da7f592aae0" FOREIGN KEY ("member_id") REFERENCES "CourseMembers"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
  }
