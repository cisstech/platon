...
export class UpdateTables1679938776451 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_3fabd37d14c4d00a506312d618" ON "CourseActivityMembers" ("activity_id") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_11ea4d9d96617503da7f592aae" ON "CourseActivityMembers" ("member_id") `
    )
    await queryRunner.query(`ALTER TABLE "CourseActivities" ADD "open_at" TIMESTAMP WITH TIME ZONE`)
    await queryRunner.query(
      `ALTER TABLE "CourseActivities" ADD "close_at" TIMESTAMP WITH TIME ZONE`
    )
    await queryRunner.query(
      `CREATE INDEX "CourseActivities_open_at_idx" ON "CourseActivities" ("open_at") `
    )
    await queryRunner.query(
      `CREATE INDEX "CourseActivities_close_at_idx" ON "CourseActivities" ("close_at") `
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "CourseActivityMembers" DROP CONSTRAINT "FK_11ea4d9d96617503da7f592aae0"`
    )
    await queryRunner.query(
      `ALTER TABLE "CourseActivityMembers" DROP CONSTRAINT "FK_3fabd37d14c4d00a506312d618b"`
    )
